...
class GhostNetV2(nn.Module):
    def __init__(self, cfgs, num_classes=1000, in_channels = 3,width=1.0, dropout=0.2,block=GhostBottleneckV2,args=None):
        ...
        self.conv_stem = nn.Conv2d(in_channels, output_channel, 3, 1, 1, bias=False)
...
def MyGhostnetv2(num_classes = 1000,in_channels = 3,width = 1.0, dropout=0.1):
    ...
    return GhostNetV2(cfgs, num_classes=num_classes,in_channels = in_channels,
                    width=width,
                    dropout=dropout)


def MyGhostnetv2_0(num_classes = 1000,in_channels = 3,width = 1.0, dropout=0.1):
...
if __name__ == '__main__':
    model = MyGhostnetv2(num_classes=10, in_channels = 3,width=1, dropout=0.1)
